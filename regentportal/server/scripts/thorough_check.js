// server/scripts/thorough_check.js
require('dotenv').config({ path: __dirname + '/../.env' });
const mongoose = require('mongoose');
const connectDB = require('../config/db');
const Test = require('../models/Test');

const thoroughCheck = async () => {
  try {
    await connectDB();
    console.log('✅ Connected to MongoDB');

    console.log('🔍 THOROUGH CHECK: Analyzing current database state...\n');

    // Focus on Book17 Test1 Listening since that's what you're testing
    ...
    console.log('📋 BOOK17 TEST1 LISTENING ANALYSIS:');
    console.log('=====================================');
